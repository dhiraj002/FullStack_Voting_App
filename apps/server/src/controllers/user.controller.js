...
import { signupSchema } from "fullstack-voting-app/schema"
...
export const addUser = async (req, res) => {
  try {
    const parsed = await signupSchema.superRefine(async (data, ctx) => {
    ...
    if(existingUser) {
      ...
      if(existingUser.aadharNumber === data.aadharNumber) {
        ctx.addIssue({
          code: "custom",
